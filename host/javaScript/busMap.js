    ...
    var searchjson = function (url, busName) {
        fetch(url)
            ...
            .then(data => {
                ...
                searchfind(`https://hifive.metainsu.co.kr/api/v1/common/sub-bus/?stid=${data[a].NODE_ID}&serverkey=${serverkey}`);
                searchfind2(`https://hifive.metainsu.co.kr/api/v1/common/sub-bus/?stid=${data[c].NODE_ID}&serverkey=${serverkey}`);
                newmarker(a, data);
                newmarker2(c, data);
            })
    }
